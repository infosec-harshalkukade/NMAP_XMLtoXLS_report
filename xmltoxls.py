# ./nmap_xml_to_xls.py [-h] [-o XLS] XML [XML]
#./nmap_xml_to_xls.py  [Huawei.xml]  -o [Huawei.xls ]        
#will shows up “up domains”
# content of nmap_xml_to_xls.py 
#Author:Harshal Kukade 
#!/usr/bin/env python
